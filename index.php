...
$db = new Database();
$vnpt = $db->select('news', '*', array('id' => 3));
...
<html>
    <head>
        <meta charset="utf-8">
        <title>Lắp mạng Internet cáp quang tốc độ cao nhiều ưu đãi tại Hà Nội</title>
    ...
    <body>
        <div class="div-right">
            <a class="btn-right btn-r1 btn-act" href="#"><span>Tại sao dùng internet VNPT?</span></a>
            <a class="btn-right btn-r2 " href="http://vnpt-hn.com/chuong-trinh-vinaphone-dong-hanh-cung-doanh-nghiep"><span>VNPT khuyến mại!</span></a>
            <div class="div-btn">
...
-->
            ...
            <div id="pop-details" class="pop-details well  popupbackground">
                <button class="pop-details_close btn btn-default" id="scale-close">X</button>
                <div class="content-right" id="scale-content">
                    <h2  class="content-title"><?php echo $vnpt[0]['title']; ?></h2>
                    <div class="content-news taisao">
                        <?php echo $vnpt[0]['content']; ?>
                    </div>
                ...
                $(document).ready(function () {
                    $('#pop-details').popup({
                        ...
                        opentransitionend: function () {
                            $('.btn-r1').addClass('btn-act');
                        },
                        closetransitionend: function () {
                            $('.btn-r1').removeClass('btn-act');
                        }
                    });
