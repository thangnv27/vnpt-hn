...
{/if}
	...
	<div id="CallDialog" style="display:none; width:350px; margin:10px">
		<div id="CallStatusHeading" style="font-family: 'Source Sans Pro', sans-serif; letter-spacing:-1px; text-shadow:0 0 1px #ccc; font-size:32px; font-weight:100; line-height:35px; color:#999">{$LOCALE.pleasewait}</div>
